...
async fn test_proxmox_get_running_vms() {
    ...
    repo.vms.lock().await.extend(vec![
        ProxmoxVM { vmid: 100, name: "vm1".to_string(), status: "running".to_string(), cpu_usage: 0.5, memory_usage: 1024, memory_total: 4096 },
        ProxmoxVM { vmid: 101, name: "vm2".to_string(), status: "stopped".to_string(), cpu_usage: 0.0, memory_usage: 0, memory_total: 4096 },
        ProxmoxVM { vmid: 102, name: "vm3".to_string(), status: "running".to_string(), cpu_usage: 0.3, memory_usage: 2048, memory_total: 4096 },
    ]);
...
async fn test_proxmox_get_high_cpu_vms() {
    ...
    repo.vms.lock().await.extend(vec![
        ProxmoxVM { vmid: 100, name: "vm1".to_string(), status: "running".to_string(), cpu_usage: 0.9, memory_usage: 1024, memory_total: 4096 },
        ProxmoxVM { vmid: 101, name: "vm2".to_string(), status: "running".to_string(), cpu_usage: 0.3, memory_usage: 1024, memory_total: 4096 },
        ProxmoxVM { vmid: 102, name: "vm3".to_string(), status: "running".to_string(), cpu_usage: 0.95, memory_usage: 1024, memory_total: 4096 },
    ]);
...
async fn test_ha_get_entities_by_domain() {
    ...
    repo.entities.lock().await.extend(vec![
        HaEntity { entity_id: "light.living_room".to_string(), state: "on".to_string(), attributes: attrs.clone(), last_updated: "2024-01-01".to_string() },
        HaEntity { entity_id: "light.kitchen".to_string(), state: "off".to_string(), attributes: attrs.clone(), last_updated: "2024-01-01".to_string() },
        HaEntity { entity_id: "sensor.temperature".to_string(), state: "22.5".to_string(), attributes: attrs.clone(), last_updated: "2024-01-01".to_string() },
    ]);
...
async fn test_ha_get_on_entities() {
    ...
    repo.entities.lock().await.extend(vec![
        HaEntity { entity_id: "light.living_room".to_string(), state: "on".to_string(), attributes: attrs.clone(), last_updated: "2024-01-01".to_string() },
        HaEntity { entity_id: "light.kitchen".to_string(), state: "off".to_string(), attributes: attrs.clone(), last_updated: "2024-01-01".to_string() },
        HaEntity { entity_id: "switch.pump".to_string(), state: "on".to_string(), attributes: attrs.clone(), last_updated: "2024-01-01".to_string() },
    ]);
...
async fn test_mqtt_get_messages_by_topic() {
    ...
    repo.messages.lock().await.extend(vec![
        MqttMessage { topic: "home/living_room/temperature".to_string(), payload: "22.5".to_string(), qos: 1, retained: true },
        MqttMessage { topic: "home/kitchen/temperature".to_string(), payload: "23.0".to_string(), qos: 0, retained: false },
        MqttMessage { topic: "sensors/outside/humidity".to_string(), payload: "60".to_string(), qos: 1, retained: true },
    ]);
...
async fn test_mqtt_count_retained_messages() {
    ...
    repo.messages.lock().await.extend(vec![
        MqttMessage { topic: "t1".to_string(), payload: "p1".to_string(), qos: 0, retained: true },
        MqttMessage { topic: "t2".to_string(), payload: "p2".to_string(), qos: 0, retained: false },
        MqttMessage { topic: "t3".to_string(), payload: "p3".to_string(), qos: 0, retained: true },
    ]);
...
async fn test_news_get_items_by_source() {
    ...
    repo.items.lock().await.extend(vec![
        NewsItem { title: "Article 1".to_string(), source: "TechCrunch".to_string(), published_at: "2024-01-01".to_string(), category: "tech".to_string(), url: "http://example.com/1".to_string() },
        NewsItem { title: "Article 2".to_string(), source: "TechCrunch".to_string(), published_at: "2024-01-02".to_string(), category: "tech".to_string(), url: "http://example.com/2".to_string() },
        NewsItem { title: "Article 3".to_string(), source: "BBC".to_string(), published_at: "2024-01-03".to_string(), category: "world".to_string(), url: "http://example.com/3".to_string() },
    ]);
    ...
    assert!(techcrunch_items.iter().all(|item| item.source == "TechCrunch"));
}
...
async fn test_news_count_by_source() {
    ...
    repo.items.lock().await.extend(vec![
        NewsItem { title: "A1".to_string(), source: "Source1".to_string(), published_at: "2024-01-01".to_string(), category: "tech".to_string(), url: "".to_string() },
        NewsItem { title: "A2".to_string(), source: "Source1".to_string(), published_at: "2024-01-02".to_string(), category: "tech".to_string(), url: "".to_string() },
        NewsItem { title: "A3".to_string(), source: "Source2".to_string(), published_at: "2024-01-03".to_string(), category: "world".to_string(), url: "".to_string() },
    ]);
