...
mod tests {
    ...
    async fn test_multiple_caches() {
        ...
        cache1.set("key1".to_string(), "value1".to_string(), None).await;
        cache2.set("key2".to_string(), "value2".to_string(), None).await;
    ...
    async fn test_cache_overwrite() {
        ...
        cache.set("key1".to_string(), "value2".to_string(), None).await;
    ...
    async fn test_cache_large_data() {
        ...
        cache.set("large".to_string(), large_string.clone(), None).await;
